    ...
    return (
        <header className="h-16 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between px-3 sm:px-6 bg-white dark:bg-[#1C1C1C] transition-colors duration-300">
            <div className="flex items-center gap-2 sm:gap-4">
                ...
                <div className="hidden sm:flex items-center text-sm text-gray-400 breadcrumbs">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
                <div className="relative">
                    ...
                    <input
                        type="text"
                        placeholder="Search"
                        className="bg-gray-100 dark:bg-gray-800 border-none rounded-lg pl-9 pr-4 py-1.5 text-sm w-32 sm:w-48 focus:ring-2 focus:ring-blue-100 dark:focus:ring-gray-700 focus:outline-none transition-all text-gray-900 dark:text-white placeholder-gray-400"
                    />
                    <span className="hidden sm:inline absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 text-xs">⌘/</span>
                </div>
                ...
                <button className="hidden md:block text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                    <History size={20} />
                </button>
                <button className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                    <Bell size={20} />
